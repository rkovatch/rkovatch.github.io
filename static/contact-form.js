document.getElementById('contact-form').addEventListener('submit', async (e) => {
    ...
    status.className = 'font-code-sm text-code-sm uppercase tracking-widest text-on-surface-alt';
    ...
    try {
        ...
        response.json().then((resp_obj) => {
            if (resp_obj.success) {
                ...
                status.className = 'font-code-sm text-code-sm uppercase tracking-widest text-primary-dim';
                btn.disabled = true;
